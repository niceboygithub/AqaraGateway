...
DEVICE_MAPPINGS = {
    ...
    "aqara.lock.wbzac1": WITH_LI_BATTERY | SUPPORT_ALARM | SUPPORT_DOORBELL | SUPPORT_WIFI | SUPPORT_CAMERA
}
...
LOCK_NOTIFICATIOIN = {
    ...
    "open in away mode": {"default": "In the Away-from-home Mode, someone opens the door indoors"},
    ...
    "unlock by bluetooth": {"default": "Unlocked with Fringprint by user"},
    "away mode": {
